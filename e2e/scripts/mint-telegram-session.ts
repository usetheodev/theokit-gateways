 ...
 * printed session string is a credential like any other — put it in `e2e/.env`
 * and in repository secrets, and every later run is unattended.
 *
 * Run: pnpm --filter @theokit/gateway-e2e session:telegram
 *
...
process.stdout.write(
  [
    "",
    "Session minted. Add this to e2e/.env and to repository secrets:",
    "",
